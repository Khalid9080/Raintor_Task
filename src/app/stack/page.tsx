    ...
    return (
        <div className='text-white bg-black rounded-2xl relative z-10 mt-40 py-16 px-10'>
            ...
            <section className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-10'>
                <div className='bg-[rgba(255,_255,_255,_0.08)] rounded-2xl p-10 my-5'>
                    <div className="icon-wrapper">
                        <FaReact className="react-icon" />
                    </div>
                    <h1 className='my-8 text-5xl'>HTML & CSS</h1>
                    <div className='w-72 text-white opacity-70'>Duis aute irure dolor in reprehenderit in voluptate. Ut enm ad minim veniam, quis</div>
